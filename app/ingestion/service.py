...
class IngestionService:
    def __init__(self, session: AsyncSession, parser_router: _ParserRouter | None = None):
        ...
        # Lazy default: importing app.providers.parsing pulls in provider
        # SDKs, which callers (tests) injecting their own router shouldn't
        # have to pay for.
    ...
    async def _get_router(self) -> _ParserRouter:
        ...
        from app.providers.parsing import get_parser_chain

        return get_parser_chain()
